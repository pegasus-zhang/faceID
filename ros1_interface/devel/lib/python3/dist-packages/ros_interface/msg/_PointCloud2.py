...
"""autogenerated by genpy from ros_interface/PointCloud2.msg. Do not edit."""
import codecs
import sys
...
class PointCloud2(genpy.Message):
  _md5sum = "4df5a2696573347510f7b13515574cfc"
  _type = "ros_interface/PointCloud2"
...
"""
  ...
  _slot_types = ['std_msgs/Header','uint32','uint32','ros_interface/PointField[]','bool','uint32','uint32','uint8[]','bool']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = ros_interface.msg.PointField()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
