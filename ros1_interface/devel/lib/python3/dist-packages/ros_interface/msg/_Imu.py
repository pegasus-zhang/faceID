...
class Imu(genpy.Message):
  _md5sum = "aba9f7059a9aa4e1b1e5cb227fa1f0a1"
...
"""
  ...
  _slot_types = ['std_msgs/Header','bool','ros_interface/Quaternion','float32[]','ros_interface/Point3D','float32[]','ros_interface/Point3D','float32[]']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_B4f().pack(_x.is_valid, _x.orientation.qx, _x.orientation.qy, _x.orientation.qz, _x.orientation.qw))
      length = len(self.orientation_covariance)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.orientation_covariance))
      _x = self
      buff.write(_get_struct_3f().pack(_x.angular_velocity.x, _x.angular_velocity.y, _x.angular_velocity.z))
      length = len(self.angular_velocity_covariance)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.angular_velocity_covariance))
      _x = self
      buff.write(_get_struct_3f().pack(_x.linear_acceleration.x, _x.linear_acceleration.y, _x.linear_acceleration.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.is_valid, _x.orientation.qx, _x.orientation.qy, _x.orientation.qz, _x.orientation.qw,) = _get_struct_B4f().unpack(str[start:end])
      ...
      (_x.angular_velocity.x, _x.angular_velocity.y, _x.angular_velocity.z,) = _get_struct_3f().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      (_x.linear_acceleration.x, _x.linear_acceleration.y, _x.linear_acceleration.z,) = _get_struct_3f().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.orientation_covariance = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      _x = self
      start = end
      end += 12
      (_x.angular_velocity.x, _x.angular_velocity.y, _x.angular_velocity.z,) = _get_struct_3f().unpack(str[start:end])
