...
(cl:defmethod cl:initialize-instance :after ((m <Vector3>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Vector3)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_interface-msg:<Vector3> is deprecated: use ros_interface-msg:Vector3 instead.")))
