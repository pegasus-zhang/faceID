...
struct MD5Sum< ::ros_interface::Header_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x0c5bf43024b68e07ULL;
  static const uint64_t static_value2 = 0x83400bcaa26f13efULL;
};
...
struct Definition< ::ros_interface::Header_<ContainerAllocator> >
{
  static const char* value()
  {
    return "uint32   seq     # std_msgs.Sequence number for each message. Each module maintains its own counter for sequence_num, always starting from 1 on boot.\n"
"Time   stamp     # 时间戳\n"
"string   frame_id     # 帧id\n"
"\n"
"================================================================================\n"
